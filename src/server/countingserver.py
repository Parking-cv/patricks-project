...
from src.server.tracker import CentroidTracker
from src.server.tracker import TrackableObject
...
import time
import threading
from src.server.eventhandler import eventhandler
import subprocess
...
while True:
    ...
    # object *detectors* to obtain a higher frame processing throughput
        ...
        for tracker in trackers:
            # set the status of our system to be 'server' rather
